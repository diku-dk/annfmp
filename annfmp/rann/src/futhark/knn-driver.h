...
// Entry points
int futhark_entry_main(struct futhark_context *ctx, struct futhark_i32_2d **out0, const int32_t in0, const int64_t in1, const struct futhark_f32_2d *in2, const struct futhark_f32_2d *in3);
