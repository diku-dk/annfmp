...
// Entry points
int futhark_entry_main(struct futhark_context *ctx, struct futhark_i32_2d **out0, const int32_t in0, const int64_t in1, const int32_t in2, const struct futhark_f32_2d *in3, const struct futhark_f32_2d *in4);
int futhark_entry_mainSuper(struct futhark_context *ctx, struct futhark_i32_2d **out0, const int32_t in0, const int64_t in1, const int32_t in2, const struct futhark_f32_2d *in3, const struct futhark_f32_2d *in4);
...
int futhark_entry_reducePatchDim(struct futhark_context *ctx, struct futhark_f32_2d **out0, const struct futhark_u8_2d *in0);
