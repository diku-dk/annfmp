...
for x in range(1, 25, 2):
    print(f"\n Current x: {x}\n")
    image_a = cv2.imread(f"../data/example/1920/{x}.jpg")
    image_b = cv2.imread(f"../data/example/1920/{x+1}.jpg")
...
print("-----------------------------------------")
print("Total OpenCLIRREG:\t{}".format(irreg))
print("Total OpenCLOPT:\t{}".format(opt))
print("Avg OpenCLIRREG:\t{}".format(avgirreg))
print("Avg OpenCLOPT:\t\t{}".format(avgopt))
print("Avg difference:\t\t{}".format(avgopt - avgirreg))
